...
DO $$ BEGIN
 ALTER TABLE "cubes_to_tactics" ADD CONSTRAINT "cubes_to_tactics_technique_id_master_threat_cubes_id_fk" FOREIGN KEY ("technique_id") REFERENCES "public"."master_threat_cubes"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "entities_to_threat_cubes" ADD CONSTRAINT "entities_to_threat_cubes_threat_cube_id_master_threat_cubes_id_fk" FOREIGN KEY ("threat_cube_id") REFERENCES "public"."master_threat_cubes"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
